...
function selectLetter(l)
{
	...
	if (to_guess.indexOf(l) != -1) {
		...
		if (display_word.indexOf("#") == -1) {
            ...
            modalBody[0].getElementsByTagName("p")[0].innerHTML = "Конгратюлейшн. Ти виграв шавуху :";
            modalBody[0].getElementsByTagName("img")[0].style.display = "block";
		...
		// lost
            let modalBody = document.getElementsByClassName("modal-body");
            modalBody[0].getElementsByTagName("p")[0].innerHTML = "Loshara.";
            $('#exampleModalCenter').modal('show');
			can_play = false;
		}
	}
