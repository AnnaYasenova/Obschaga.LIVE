...
var text_stage = {
  ...
  "commenda_vnuchok": {
    "ukr": "<p>Ну какби дєло в шляпє. Майже.</p><p>До речі, поки ти там возився, до комєнди " + 
  ...
  "commenda_second_attempt": [
    {
      ...
      "action": "player.mood -= 5; player.respect -= 5;"
    }, 
    {
      "text": {
  ...
  "commenda_conditions": [    
    {
      ...
      "action": "player.energy -= 2; player.cash -= 200;"
    }, 
    {
      "text": {
        "ukr": "Я трудяжка, го всьо помию."
      },
      "action": "player.respect -= 5; player.mood -= 10; player.energy -= 10"
    }, 
    {
      "text": {
